...
const Finance = () => {
    return (
        <main>
            ...
            <section className="finance-description">
                <div className="container finance-description-container">
                    ...
                    <p>Each requirement is assessed against the asset, borrower profile, timeline and exit strategy, then aligned to an appropriate lender and facility structure with careful attention to security, documentation and deliverability. Oakstone Finance supports clients from initial feasibility through lender engagement, negotiation and completion, maintaining direct communication and a pragmatic focus on outcomes.</p>
                </div>
            </section>
            ...
            <section className="finance-strategic">
                <div className="container finance-strategic-container">
                    <h2>Property Finance Solutions</h2>
                    ...
                    <div className="finance-grid">
                        ...
                        <div className="finance-col">
                            ...
                            <p>Funding for investment and owner-occupied commercial property, structured to tenant profile, income quality and asset fundamentals. Optimised terms for acquisitions, refinances and capital raising.</p>
                        </div>
        ...
        <div className="container container-narrow">
          ...
          <p>For further detail on our UK specialist property finance services and approach, please visit the Oakstone Finance website.</p>
          <a href="/about#contact" className="btn-primary"> Visit Oakstone Finance</a>
        </div>
      </section>
